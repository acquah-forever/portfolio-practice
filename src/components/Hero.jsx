...
const Hero = () => {
    return (
        <motion.div initial={{opacity:0, y:-60}} animate={{opacity:1, y:0}} transition={{duration:0.9, ease:'easeInOut'}} className='flex flex-col-reverse p-10 mt-15 md:flex-row justify-center items-center md:min-h-screen space-x-25'>
