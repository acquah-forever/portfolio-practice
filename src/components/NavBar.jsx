  ...
  return (
    <>
      <div className='sticky z-5 top-3 backdrop-blur-sm rounded mx-5 flex justify-between items-center px-5 py-2 shadow-2xl dark:shadow-none'>
        <NavLink to={'/'}><h1 className='cursor-pointer text-xl hover:scale-115 transition-all ease-in-out duration-300'>Kojo Acquah{" "}<span className='cursor-pointer text-2xl sm:text-xl lg:text-2xl bg-linear-to-r from-orange-600 to-amber-400 text-transparent bg-clip-text hover:scale-115 transition-all ease-in-out duration-400'>Addo</span></h1></NavLink>
        <div className='flex space-x-3 sm:space-x-5 md:space-x-7 lg:space-x-10'>
          ...
          <ul className='hidden  sm:flex space-x-4 sm:space-x-5 md:space-x-10 tracking-tight items-center'>
            <NavLink to={'/'}><li className='text-2xl dark:bg-linear-to-r dark:from-orange-700 dark:to-amber-400 dark:text-transparent dark:bg-clip-text cursor-pointer hover:scale-115 transition-all ease-in-out duration-300'>Home</li></NavLink>
            <NavLink to={'/portfolio'}><li className='text-2xl dark:bg-linear-to-r dark:from-orange-700 dark:to-amber-400 dark:text-transparent dark:bg-clip-text cursor-pointer hover:scale-115 transition-all ease-in-out duration-300'>Portfolio</li></NavLink>
          </ul>
